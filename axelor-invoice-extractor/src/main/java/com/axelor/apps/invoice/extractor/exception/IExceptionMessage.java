...
public interface IExceptionMessage {
  ...
  public static final String PDF_OR_TEMPLATE_ERROR = /*$$(*/ "Please add Pdf or Template for extract data."; /*)*/
  public static final String TEMPLATE_ERROR = /*$$(*/ "ERROR:invoice2data.main:No template."; /*)*/
  public static final String ROOT_ERROR = /*$$(*/
      "ERROR:root:Unable to match all required fields"; /*)*/
