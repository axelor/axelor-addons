...
import com.axelor.apps.invoice.extractor.service.TemplateExtractorServiceImpl;

public class InvoiceExtractorModule extends AxelorModule {

  @Override
  protected void configure() {
    bind(TemplateExtractorService.class).to(TemplateExtractorServiceImpl.class);
