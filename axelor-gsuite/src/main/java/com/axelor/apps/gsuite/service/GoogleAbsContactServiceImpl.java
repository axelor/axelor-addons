...
public class GoogleAbsContactServiceImpl implements GoogleAbsContactService {
    ...
    try {
      ...
      if (credential == null) {
        throw new AxelorException(
            ...
            String.format(
                I18n.get(com.axelor.apps.gsuite.exception.IExceptionMessage.AUTH_EXCEPTION_1),
