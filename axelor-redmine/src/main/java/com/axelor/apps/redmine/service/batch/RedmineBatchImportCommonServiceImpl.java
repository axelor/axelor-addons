...
import com.axelor.apps.redmine.service.imports.RedmineExcelLogService;
...
public class RedmineBatchImportCommonServiceImpl implements RedmineBatchImportCommonService {

  protected RedmineExcelLogService redmineExcelLogService;

  @Inject
  public RedmineBatchImportCommonServiceImpl(RedmineExcelLogService redmineExcelLogService) {
