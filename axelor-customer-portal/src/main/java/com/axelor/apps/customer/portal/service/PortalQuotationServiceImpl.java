...
public class PortalQuotationServiceImpl implements PortalQuotationService {
  ...
  public PortalQuotation getRequestedPortalQuotation(SaleOrder saleOrder) {
    ...
    return Beans.get(PortalQuotationRepository.class)
        .all()
  ...
  public PortalQuotation createPortalQuotation(SaleOrder saleOrder)
    ...
    portalQuotation.setEndOfValidity(saleOrder.getEndOfValidityDate());
  ...
  protected void sendQuotationCreationMessage(
    ...
    try {
      ...
      managePortalRelatedTo(message, portalQuotation);
  ...
  protected void managePortalRelatedTo(Message message, PortalQuotation portalQuotation) {

    if (message == null || portalQuotation == null) {
      return;
    }

    messageService.addMessageRelatedTo(
        message, PortalQuotation.class.getCanonicalName(), portalQuotation.getId());
