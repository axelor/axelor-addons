...
public class PrestashopProduct extends PrestashopIdentifiableEntity {
  private static List<String> READONLY_ATTRIBUTES = Arrays.asList("manufacturer_name", "quantity");
  ...
  public Associations getAssociations() {
    if (isVirtual() && associations.getAdditionalEntries() != null) {
      ...
      for (ListIterator<Element> it = associations.getAdditionalEntries().listIterator();
          it.hasNext(); ) {
