...
public class ImportMetaDataServiceImpl implements ImportMetaDataService {
  ...
  public void importLanguages(PSWebServiceClient ws) throws PrestaShopWebserviceException {
    ...
    for (PrestashopLanguage remoteLanguage : remoteLanguages) {
      Language localLanguage =
          languageRepository.findByCode(remoteLanguage.getIsoCode().toUpperCase());
  ...
  @Override
  @Transactional
  public void importOrderStatuses(Language prestashopLanguage, PSWebServiceClient ws)
      throws PrestaShopWebserviceException {
    final List<PrestashopOrderStatus> remoteStatuses =
        ws.fetchAll(PrestashopResourceType.ORDER_STATUSES);
