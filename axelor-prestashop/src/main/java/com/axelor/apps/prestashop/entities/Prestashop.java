...
/**
 * Common root tag for all API calls. Interesting content is in content attribute, which should be
 * casted based on the kind of request.
 */
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
public class Prestashop {
  @XmlElementRef private PrestashopContainerEntity content;
  // Some structures (eg. images) have an additional content element
  // avoid parsing issues
  @XmlAnyElement private List<Element> additionalAttributes;
