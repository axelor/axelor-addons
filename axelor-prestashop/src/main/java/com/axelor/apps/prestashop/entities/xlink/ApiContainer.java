...
public class ApiContainer extends PrestashopContainerEntity {
  @XmlAttribute private String shopName;

  @XmlElementRef private List<XlinkEntry> xlinkEntries = new LinkedList<>();

  @XmlAnyElement private List<Element> unknownEntries = new LinkedList<>();
